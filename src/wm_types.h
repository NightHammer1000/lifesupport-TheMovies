...
/* Writer-path CLSIDs used by the in-game export pipeline.
   See STATUS.md → "Writer (movie export) call surface" for the full
   sequence in which the game uses these. */
static const GUID CLSID_CaptureGraphBuilder2 =
    {0xBF87B6E1, 0x8C27, 0x11D0, {0xB3,0xF0,0x00,0xAA,0x00,0x37,0x61,0xC5}};
static const GUID CLSID_WMAsfWriter =
    {0x7C23220E, 0x55BB, 0x11D3, {0x8B,0x16,0x00,0xC0,0x4F,0xB6,0xBD,0x3D}};
static const GUID CLSID_AsyncReader =
...
/* IIDs the game QIs from the writer / sink pipeline.
   IID_IFileSourceFilter and IID_IMediaEvent are already in ds_types.h. */
static const GUID IID_ICaptureGraphBuilder2 =
    {0x93E5A4E0, 0x2D50, 0x11D2, {0xAB,0xFA,0x00,0xA0,0xC9,0xC6,0xE3,0x8D}};
static const GUID IID_IFileSinkFilter =
    {0xA2104830, 0x7C70, 0x11CF, {0x8B,0xCE,0x00,0xAA,0x00,0xA3,0xF1,0xA6}};
static const GUID IID_IConfigAsfWriter =
    {0x45086030, 0xF7E4, 0x486A, {0xB5,0x04,0xB7,0xB7,0x9C,0x4D,0xC7,0xCC}};
